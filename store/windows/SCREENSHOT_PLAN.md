...
- Use screenshots from the exact validated Windows Store candidate, never the development server.
...
- Use synthetic experiment data only.
...
## Uploaded four-image set and captions

### 01 — Overview

File: `01-overview-1366x768.png`

SHA-256: `080d92f628ef8e07ec8c761da37ce6880d53e1c6eb81588dac6005d07ea2ed95`
...
File: `02-import-mapping-1366x768.png`

SHA-256: `00a529fbba0cd9d5365913af7e6a8ccd736dec97067eb0f8ae189301aecc0060`
...
File: `03-local-results-1366x768.png`

SHA-256: `a75351dcf56bb96f512be96aafdc2536c6657e793879b6b86ff794848808f3c6`
...
File: `04-evidence-reports-1366x768.png`

SHA-256: `a2364a493b4ad85c1a089932b42ba1d075145f5be81c6cd384ff33a0fddea862`
...
The English listing contains these four exact Store-candidate images in this order: Overview, Import/mapping, Results with visible diagnostics, and Reports/export. Microsoft requires at least one Desktop screenshot and recommends four or more.
...
- [x] Captured from the exact Store candidate, not the development server
- [ ] Correct Windows version and x64 package recorded
- [x] Actual feature shown works in the packaged x64 build that matches the inspected Store payload
- [x] Synthetic data only
- [x] No personal or confidential information
- [x] No local paths, tokens, credentials, or machine username visible
- [x] No macOS window chrome
- [x] No visual test overlays or browser developer tools
- [x] PNG dimensions and file size verified
- [x] Caption is 200 characters or fewer
- [x] Critical content remains in the top two-thirds
- [x] Screenshot SHA-256 recorded above

## Partner Center state
